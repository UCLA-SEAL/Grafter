...
public class Actions {
  ...
  public final Action LOAD = new Action("Load");
  public final Action EXPORT = new Action("Export");
  ...
  public final Action COVERAGE = new Action("Coverage");
  public final Action GRAFTLEFT = new Action("GraftLeft");
  public final Action GRAFTRIGHT = new Action("GraftRight");
