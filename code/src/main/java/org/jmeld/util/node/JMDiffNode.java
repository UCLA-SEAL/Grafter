    ...
    implements TreeNode
{
  ...
  // the range of each clone to compare
  public int leftStart = -1;
  public int leftEnd = -1;
  public int rightStart = -1;
  public int rightEnd = -1;
  ...
  public void diff(int start1, int end1, int start2, int end2)
	      throws JMeldException
	  {
	    ...
	    revision = diff.diff(left, right, start1, end1, start2, end2, ignore);
	    StatusBar.getInstance().setState("Ready calculating differences");
	    StatusBar.getInstance().stop();
	  }
